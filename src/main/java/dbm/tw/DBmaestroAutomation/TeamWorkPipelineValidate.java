...
public class TeamWorkPipelineValidate extends Builder {
    ...
    private final boolean useLabelName;
    ...
    public TeamWorkPipelineValidate(String pipelineName, String environmentName, boolean useOtherEnvironment, String otherEnvironmentName, String actionType,
                                    boolean useLabelName, String labelName, boolean useFileName, String fileName  ) {
        this.pipelineName = pipelineName;
        this.environmentName = environmentName;
        this.useOtherEnvironment = useOtherEnvironment;
        this.otherEnvironmentName = otherEnvironmentName;
        this.actionType = actionType;
        this.useLabelName = useLabelName;
    ...
    public boolean getUseLabelName() {
        return useLabelName;
    }
    ...
    public boolean perform(AbstractBuild build, Launcher launcher, BuildListener listener) {
        try{
            ...
            if(useLabelName){
                args.add("-LabelName");
                args = CommonFunctions.AddQuoted(args, labelName);
            }
            if(useFileName){
                args.add("-FileName");
                args = CommonFunctions.AddQuoted(args, fileName);
            }
            args.add("-Action");
    ...
    /**
     * Descriptor for {@link dbm.tw.DBmaestroAutomation.TeamWorkPipelineValidate}. Used as a singleton.
    ...
    public static final class DescriptorImpl extends BuildStepDescriptor<Builder> {
        ...
        public String getDisplayName() {
            return "DBmaestro validate state";
        }

...
public class TeamWorkPipelineGenerateDeploymentScriptByTask extends Builder {
    ...
    public TeamWorkPipelineGenerateDeploymentScriptByTask(String pipelineName, String environmentName, boolean useOtherEnvironment, String otherEnvironmentName,
                                                          String tasks,String actionType) {
    ...
    public boolean perform(AbstractBuild build, Launcher launcher, BuildListener listener) {
        try{
            ...
            args.add("-GenerateDeploymentScriptByTask");
            args.add("-Pipeline");
            ...
            args.add("-Tasks");
            args = CommonFunctions.AddQuoted(args, CommonFunctions.ReplaceEnvironmentVariables(tasks,build,listener));
            args.add("-Action");
    ...
    /**
     * Descriptor for {@link dbm.tw.DBmaestroAutomation.TeamWorkPipelineGenerateDeploymentScriptByTask}. Used as a singleton.
    ...
    public static final class DescriptorImpl extends BuildStepDescriptor<Builder> {
        ...
        public String getDisplayName() {
            return "DBmaestro detailed step: Generate by task";
        }

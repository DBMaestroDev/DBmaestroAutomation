...
public class TeamWorkPipelineGenerateDeploymentScriptBetweenLabels extends Builder {
    ...
    private final boolean useBaselineLabelName;
    private final String baselineLabelName;
    private final String actionType;

    // Fields in config.jelly must match the parameter names in the "DataBoundConstructor"
    @DataBoundConstructor
    public TeamWorkPipelineGenerateDeploymentScriptBetweenLabels(String pipelineName, String environmentName, boolean useOtherEnvironment,
                                                                 String otherEnvironmentName, String labelName, String targetLabelName,
                                                                 boolean useBaselineLabelName, String baselineLabelName, String actionType) {
        ...
        this.useBaselineLabelName = useBaselineLabelName;
        this.baselineLabelName = baselineLabelName;
    ...
    public boolean getUseBaselineLabelName() {
        return useBaselineLabelName;
    }
    public String getBaselineLabelName() {
        return baselineLabelName;
    }
    ...
    public boolean perform(AbstractBuild build, Launcher launcher, BuildListener listener) {
        try{
            ...
            args.add("-GenerateDeploymentScriptBetweenLabels");
            args.add("-Pipeline");
            ...
            args.add("-TargetLabelName");
            args = CommonFunctions.AddQuoted(args, CommonFunctions.ReplaceEnvironmentVariables(targetLabelName,build,listener));
            if(useBaselineLabelName){
                args.add("-BaselineLabelName");
                args = CommonFunctions.AddQuoted(args, CommonFunctions.ReplaceEnvironmentVariables(baselineLabelName,build,listener));
            }
            args.add("-Action");
    ...
    /**
     * Descriptor for {@link dbm.tw.DBmaestroAutomation.TeamWorkPipelineGenerateDeploymentScriptBetweenLabels}. Used as a singleton.
    ...
    public static final class DescriptorImpl extends BuildStepDescriptor<Builder> {
        ...
        public String getDisplayName() {
            return "DBmaestro detailed step: Generate between labels";
        }

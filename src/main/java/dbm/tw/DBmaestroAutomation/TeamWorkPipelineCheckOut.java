...
public class TeamWorkPipelineCheckOut extends Builder {
    ...
    public TeamWorkPipelineCheckOut(String pipelineName, String environmentName) {
    ...
    /**
     * Descriptor for {@link dbm.tw.DBmaestroAutomation.TeamWorkPipelineCheckOut}. Used as a singleton.
    ...
    public static final class DescriptorImpl extends BuildStepDescriptor<Builder> {
        ...
        public String getDisplayName() {
            return "DBmaestro detailed step: Check-out";
        }

...
public class TeamWorkPipelineGenerateDeploymentScriptByLabel extends Builder {
    ...
    public TeamWorkPipelineGenerateDeploymentScriptByLabel(String pipelineName, String environmentName, boolean useOtherEnvironment, String otherEnvironmentName, String labelName,String actionType) {
    ...
    public boolean perform(AbstractBuild build, Launcher launcher, BuildListener listener) {
        try{
            ...
            args.add("-GenerateDeploymentScriptByLabel");
            args.add("-Pipeline");
    ...
    /**
     * Descriptor for {@link dbm.tw.DBmaestroAutomation.TeamWorkPipelineGenerateDeploymentScriptByLabel}. Used as a singleton.
    ...
    public static final class DescriptorImpl extends BuildStepDescriptor<Builder> {
        ...
        public String getDisplayName() {
            return "DBmaestro detailed step: Generate specific label";
        }

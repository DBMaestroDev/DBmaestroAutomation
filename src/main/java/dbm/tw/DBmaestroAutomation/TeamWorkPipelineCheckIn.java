...
public class TeamWorkPipelineCheckIn extends Builder {
    ...
    public TeamWorkPipelineCheckIn(String pipelineName, String environmentName, String comment, boolean useFile, String filePath, boolean useTask, String taskName) {
    ...
    /**
     * Descriptor for {@link dbm.tw.DBmaestroAutomation.TeamWorkPipelineCheckIn}. Used as a singleton.
    ...
    public static final class DescriptorImpl extends BuildStepDescriptor<Builder> {
        ...
        public String getDisplayName() {
            return "DBmaestro detailed step: Check-in";
        }

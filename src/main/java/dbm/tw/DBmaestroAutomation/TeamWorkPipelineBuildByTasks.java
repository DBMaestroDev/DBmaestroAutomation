...
public class TeamWorkPipelineBuildByTasks extends Builder {
    ...
    public TeamWorkPipelineBuildByTasks(String pipelineName, String environmentName, boolean useOtherEnvironment, String otherEnvironmentName, String tasks, String actionType) {
    ...
    /**
     * Descriptor for {@link dbm.tw.DBmaestroAutomation.TeamWorkPipelineBuildByTasks}. Used as a singleton.
    ...
    public static final class DescriptorImpl extends BuildStepDescriptor<Builder> {
        ...
        public String getDisplayName() {
            return "DBmaestro build by tasks";
        }

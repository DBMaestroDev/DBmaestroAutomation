...
public class TeamWorkPipelineBuildLatestLabel extends Builder {
    ...
    public TeamWorkPipelineBuildLatestLabel(String pipelineName, String environmentName, boolean useOtherEnvironment, String otherEnvironmentName, String newLabelName, String actionType) {
    ...
    /**
     * Descriptor for {@link dbm.tw.DBmaestroAutomation.TeamWorkPipelineBuildLatestLabel}. Used as a singleton.
    ...
    public static final class DescriptorImpl extends BuildStepDescriptor<Builder> {
        ...
        public String getDisplayName() {
            return "DBmaestro build latest revision";
        }

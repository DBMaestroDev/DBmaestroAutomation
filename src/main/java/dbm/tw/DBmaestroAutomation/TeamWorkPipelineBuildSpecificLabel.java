...
public class TeamWorkPipelineBuildSpecificLabel extends Builder {
    ...
    public TeamWorkPipelineBuildSpecificLabel(String pipelineName, String environmentName, boolean useOtherEnvironment, String otherEnvironmentName, String labelName, String actionType) {
    ...
    /**
     * Descriptor for {@link dbm.tw.DBmaestroAutomation.TeamWorkPipelineBuildSpecificLabel}. Used as a singleton.
    ...
    public static final class DescriptorImpl extends BuildStepDescriptor<Builder> {
        ...
        public String getDisplayName() {
            return "DBmaestro build specific label";
        }

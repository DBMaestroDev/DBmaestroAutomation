...
public class TeamWorkPipelineBuildBetweenLabels extends Builder {
    ...
    public TeamWorkPipelineBuildBetweenLabels(String pipelineName, String environmentName, boolean useOtherEnvironment,
    ...
    /**
     * Descriptor for {@link dbm.tw.DBmaestroAutomation.TeamWorkPipelineBuildBetweenLabels}. Used as a singleton.
    ...
    public static final class DescriptorImpl extends BuildStepDescriptor<Builder> {
        ...
        public String getDisplayName() {
            return "DBmaestro build between labels";
        }

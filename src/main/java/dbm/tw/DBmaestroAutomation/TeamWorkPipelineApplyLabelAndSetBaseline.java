...
public class TeamWorkPipelineApplyLabelAndSetBaseline extends Builder {
    ...
    public TeamWorkPipelineApplyLabelAndSetBaseline(String pipelineName, String environmentName, String labelName, String labelDescription, String baselineEnvironmentName) {
    ...
    public boolean perform(AbstractBuild build, Launcher launcher, BuildListener listener) {
        try{
            ...
            args.add("-ApplyLabelAndSetBaseline");
            args.add("-Pipeline");
    ...
    /**
     * Descriptor for {@link dbm.tw.DBmaestroAutomation.TeamWorkPipelineApplyLabelAndSetBaseline}. Used as a singleton.
    ...
    public static final class DescriptorImpl extends BuildStepDescriptor<Builder> {
        ...
        public String getDisplayName() {
            return "DBmaestro detailed step: Apply label and set baseline";
        }

...
public class TeamWorkPipelineExitIntegration extends Builder {
    ...
    public TeamWorkPipelineExitIntegration(String pipelineName, String environmentName) {
    ...
    /**
     * Descriptor for {@link dbm.tw.DBmaestroAutomation.TeamWorkPipelineExitIntegration}. Used as a singleton.
    ...
    public static final class DescriptorImpl extends BuildStepDescriptor<Builder> {
        ...
        public String getDisplayName() {
            return "DBmaestro detailed step: Exit deployment mode";
        }
